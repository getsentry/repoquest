...
export const SKILLS: SkillDefinition[] = [
  ...
  // Code Quality (5)
  {
    ...
    label: "Type Checking",
    filePaths: [
      "tsconfig.json", "mypy.ini", ".mypy.ini", "pyrightconfig.json", ".swiftlint.yml",
  ...
  },
  {
    ...
    filePaths: [
      ...
      "ruff.toml",
      "detekt.yml", "detekt.yaml", ".detekt.yml",
      "checkstyle.xml", ".checkstyle",
      "ktlint.gradle", "ktlint.gradle.kts",
      ".swiftlint.yml",
      "analysis_options.yaml",
    ],
  ...
  },
  {
    ...
    category: "codeQuality",
    label: "Pre-commit",
    filePaths: [".pre-commit-config.yaml", ".husky", ".githooks", "lefthook.yml", ".lefthook.yml"],
  ...
  },
  {
    ...
    filePaths: [
      ...
      "pytest.ini", "setup.cfg", "conftest.py", "pyproject.toml",
      "phpunit.xml", ".rspec",
      "build.gradle.kts", "build.gradle",
      "Cargo.toml",
      "pubspec.yaml", "dart_test.yaml",
      "test", "tests", "spec",
    ],
